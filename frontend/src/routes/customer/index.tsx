...
import { BedDouble, UtensilsCrossed, CalendarDays, Receipt } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/customer" className="text-2xl font-bold text-slate-900">
            Hotel System
          </Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-12">
          ...
          >
            ...
            <h2 className="font-bold text-slate-900">Book a Room</h2>
          ...
          >
            ...
            <h2 className="font-bold text-slate-900">Restaurant</h2>
            <p className="text-sm text-slate-500 mt-1">
          ...
          >
            ...
            <h2 className="font-bold text-slate-900">My Bookings</h2>
            <p className="text-sm text-slate-500 mt-1">
